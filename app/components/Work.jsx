    ...
    >
      ...
      >
        {workData.map((project, index) => (
          ...
          >
            <div className="bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between dutarion-500 group-hover:bottom-7">
              <div>
      ...
      <motion.a
        ...
        href="https://github.com/Sagarsah3413?tab=repositories"
        target="_blank"
