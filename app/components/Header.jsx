...
const Header = () => {
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col justify-center items-center gap-4">
      ...
      >
        I’m a full-stack developer experience in multiple company like
        Innovaccer and M.N. Software Pvt. Ltd., skilled in building scalable
        front-end and back-end solutions using modern technologies.
      </motion.p>
